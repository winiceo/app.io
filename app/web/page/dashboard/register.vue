 ...
 <el-form-item prop="captcha">
            <span class="svg-container svg-container_login">
              <icon-svg icon-class="yonghuming"/>
                 ...
                 <el-input placeholder="输入验证码" v-model="captcha">
                <template slot="append"><img src='/captcha'></template>
              </el-input>
            </el-form-item>sdf
            ...
            <el-button type="primary" style="width:100%;margin-bottom:10px;" :loading="loading"
                       @click.native.prevent="handleLogin">登录
            </el-button>
            <el-button type="primary" style="width:100%;margin-bottom:30px;color:gray"
